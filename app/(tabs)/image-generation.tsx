...
const styleTemplates: StyleTemplate[] = [
  ...
  { id: "artistic-1", title: "去痘痕", image: getAssetUrl("figma-designs/artistic/IMAGE-1.png"), afterImage: getAssetUrl("figma-designs/artistic/IMAGE-1-after.png"), category: "retouch", prompt: "去掉图中人物脸上的青春痘或雀斑" },
    ...
    try {
      ...
      const response = await fetch(getApiUrl('api/jobs'), {
        ...
        body: JSON.stringify({
          ...
          referenceImageUrl2: uploadedUrls[1], // 第二张图片（如果有）
          provider: 'openai', // 可以根据需求选择不同的提供商
        }),
      });
      ...
      // 轮询检查任务状态
      await pollJobStatus(result.id || result.jobId);
